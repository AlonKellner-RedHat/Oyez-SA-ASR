#!/usr/bin/env python3
# Generated by Claude
"""Demo: Loading and using the oyez-sa-asr-flex dataset.
...
def main() -> None:
    ...
    recordings = load_parquet(args.dataset_dir / "recordings.parquet")
    utterances = load_parquet(args.dataset_dir / "utterances.parquet")
